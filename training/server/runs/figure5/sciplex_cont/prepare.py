...
original_notebook_path = '/home/icb/kemal.inecik/work/codes/tardis/training/server/runs/figure5/sciplex_cont/base/sciplex_dose.ipynb'

# Load the original notebook
nb = load_notebook(original_notebook_path)

# Increment seed from 0 to 14
increment_seed(nb, 'ood_seed', 0, 14)
