...
def increment_seed(nb: NotebookNode, var_name: str, start_seed: int, end_seed: int) -> None:
        ...
        for cell in nb.cells:
            if cell.cell_type == 'code':
                ...
                if var_name in cell.source:
                    ...
                    new_filename = f'notebook_seed_{new_seed}.ipynb'
                    save_notebook(nb, new_filename)
                    print(f'Saved: {new_filename}')
                    break

# Path to the original notebook
original_notebook_path = '/home/icb/kemal.inecik/work/codes/tardis/training/server/runs/figure5/miller_cont/base/miller_ood_cont_base.ipynb'

# Load the original notebook
nb = load_notebook(original_notebook_path)

# Increment seed from 0 to 16
increment_seed(nb, 'ood_seed', 0, 16)
