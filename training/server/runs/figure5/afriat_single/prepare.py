...
for identifier in [1, 2, 3]:
    ...
    original_notebook_path = f'/home/icb/kemal.inecik/work/codes/tardis/training/server/runs/figure5/afriat_single/base/afriat_v2_4_1_base_{identifier}.ipynb'

    # Load the original notebook
    nb = load_notebook(original_notebook_path)

    # Increment seed from 0 to 21
    increment_seed(nb, 'ood_seed', 0, 21, identifier=identifier)
