...
for identifier in [1, 2]:
    ...
    original_notebook_path = f'/home/icb/kemal.inecik/work/codes/tardis/training/server/runs/figure4/miller_single/base/miller_ood_{identifier}.ipynb'

    # Load the original notebook
    nb = load_notebook(original_notebook_path)

    # Increment seed from 0 to 21
    increment_seed(nb, 'ood_seed', 0, 16, identifier=identifier)
