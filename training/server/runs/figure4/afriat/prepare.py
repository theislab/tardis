...
original_notebook_path = '/home/icb/kemal.inecik/work/codes/tardis/training/server/runs/figure4/afriat/base/afriat_v2_4_1_base.ipynb'

# Load the original notebook
nb = load_notebook(original_notebook_path)

# Increment seed from 0 to 21
increment_seed(nb, 'ood_seed', 0, 21)
