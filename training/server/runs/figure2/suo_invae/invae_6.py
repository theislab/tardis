...
with warnings.catch_warnings():
    ...
    model.train(n_epochs=100, lr_train=0.0001, weight_decay=0.001)

model.save("/home/icb/kemal.inecik/lustre_workspace/tardis_data/models/invae_6.pt")
...
joblib.dump(invariant, "/home/icb/kemal.inecik/lustre_workspace/tardis_data/processed/inveriant_6.joblib")
joblib.dump(spurious, "/home/icb/kemal.inecik/lustre_workspace/tardis_data/processed/spurious_6.joblib")
