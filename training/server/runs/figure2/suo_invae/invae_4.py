...
with warnings.catch_warnings():
    ...
    model.train(n_epochs=50, lr_train=0.001, weight_decay=0.0001)

model.save("/home/icb/kemal.inecik/lustre_workspace/tardis_data/models/invae_4.pt")
...
joblib.dump(invariant, "/home/icb/kemal.inecik/lustre_workspace/tardis_data/processed/inveriant_4.joblib")
joblib.dump(spurious, "/home/icb/kemal.inecik/lustre_workspace/tardis_data/processed/spurious_4.joblib")
